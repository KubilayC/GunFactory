...
public class GrabGun : MonoBehaviour
{
    ...
    public int rotation;
    public GameObject stockToHand;
    public GameObject scopeToHand;
    public GameObject magToHand;
    public GameObject bodyToHand;
    ...
    private IEnumerator LightUpSquare()
    {
        ...
        if (playerController.offStock.activeSelf && playerController.offScope.activeSelf && playerController.offMag.activeSelf && playerController.offBody.activeSelf)
        {
            ...
            magToHand.SetActive(true);
            bodyToHand.SetActive(true);
            scopeToHand.SetActive(true);
            stockToHand.SetActive(true);
